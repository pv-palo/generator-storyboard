                ...
                <div className="flex-1 bg-white border border-[#d1d7c9] hover:border-[#b0b8a8] rounded-xl p-3 px-3.5 shadow-3xs transition-all relative">
                  <div className="flex items-center justify-between mb-2.5 border-b border-[#f0f3eb] pb-1.5">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <button onClick={() => handleMoveDown(index)} disabled={index === frames.length - 1} className="p-1 text-[#5a6b5c] hover:text-[#1a2d1d] disabled:opacity-20 cursor-pointer">
                        <ChevronDown className="h-4 w-4" />
                      </button>
                      <div className="w-px h-3.5 bg-[#cbd0c4]/60 mx-0.5" />
                      <button onClick={() => handleDeleteFrame(index)} className="p-1 text-[#5a6b5c] hover:text-red-500 cursor-pointer">
